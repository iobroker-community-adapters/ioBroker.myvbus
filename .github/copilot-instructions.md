...
8. [VBus-Specific Guidance](#vbus-specific-guidance)
   - [VBus Connection Management](#vbus-connection-management)
   - [VBus Protocol Specifics](#vbus-protocol-specifics)
